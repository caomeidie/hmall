<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="<?php echo U('goods_attr/index');?>">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="<?php echo U('goods_attr/index');?>" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="add" href="<?php echo U('goods_attr/add');?>" target="navTab"><span>添加</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="check" postType="string" href="<?php echo U('goods_attr/del');?>" class="delete"><span>删除</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
		<?php if(is_array($attr_list)): foreach($attr_list as $key=>$value): ?><tr target="sid" rel="<?php echo ($value['attr_id']); ?>">
                ...
                <td>
                    <a title="删除" target="ajaxTodo" href="<?php echo U('goods_attr/del',array('uid'=>$value['attr_id']));?>" class="btnDel">删除</a>
					<a title="编辑" target="navTab" href="<?php echo U('goods_attr/edit',array('uid'=>$value['attr_id']));?>" class="btnEdit">编辑</a>
                </td>
