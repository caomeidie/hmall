<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="<?php echo U('article/index');?>">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="<?php echo U('article/index');?>" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="add" href="<?php echo U('article/add');?>" target="navTab"><span>添加</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="check" postType="string" href="<?php echo U('article/del');?>" class="delete"><span>删除</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
		<?php if(is_array($article_list)): foreach($article_list as $key=>$value): ?><tr target="sid" rel="<?php echo ($value['article_id']); ?>">
                ...
                <td>
                    <a title="删除" target="ajaxTodo" href="<?php echo U('article/del',array('uid'=>$value['article_id']));?>" class="btnDel">删除</a>
					<a title="编辑" target="navTab" href="<?php echo U('article/edit',array('uid'=>$value['article_id']));?>" class="btnEdit">编辑</a>
                </td>
